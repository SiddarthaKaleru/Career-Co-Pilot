...
Resume Information Parser (data_extractor):
...
Advanced ATS Simulator (ats_analyst):
...
Resume Evaluation Expert (resume_screener):
...
Final Report Compiler (final_report_compiler):
